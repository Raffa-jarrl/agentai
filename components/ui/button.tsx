...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-brand text-white hover:bg-brand-600 hover:shadow-sm active:shadow-xs",
        secondary: "bg-muted text-foreground hover:bg-muted/80 hover:shadow-sm",
        outline: "border border-input bg-background hover:bg-muted hover:shadow-sm",
        ghost: "hover:bg-muted",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-sm",
        teal: "bg-teal text-white hover:bg-teal-600 hover:shadow-sm",
      },
      size: {
